...
def generate_pdf_report(species, family, confidence, taxonomy, family_info, inputs):
    ...
    c.drawString(100, y, "South Indian Medicinal Herb Classification Report")
    y -= 20
...
if page == "Welcome":
    ...
    st.title("🌿 Welcome to South Indian Medicinal Herb Classifier")
    st.markdown("""
...
# Classifier Page
    ...
    st.title("🌿 South Indian Medicinal Herb Classifier")
    st.markdown("""
...
""")
st.markdown("---")
# Footer with logo and name
st.markdown('<div class="footer-container">', unsafe_allow_html=True)
# Simplified string formatting to avoid interpolation issues
footer_html = (
    '<img src="' + logo_base64 + '" alt="Logo" style="vertical-align: middle; width: 40px; height: 40px;">'
    '<span>'
'Developed by J.Jaydish Kennedy</span>'
)
